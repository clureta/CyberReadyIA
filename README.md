# CyberReadyIA
CyberReady AI es una plataforma en fase de prototipado que explora el uso de IA agéntica y Regulatory Chaos Engineering para simular ciberincidentes, identificar dependencias críticas y evaluar si una organización podría ejecutar realmente su respuesta antes de enfrentar una crisis real. Nace en Chile con visión de escalabilidad hacia LA.
# CyberReady AI

> **Simula hoy. Descubre dónde fallarías mañana.**

**CyberReady AI** es una propuesta de innovación en **ciberseguridad e inteligencia artificial agéntica** que busca ayudar a CISOs y organizaciones a responder una pregunta simple pero crítica:

> **Si mañana ocurre un ciberincidente, ¿nuestro plan realmente funcionaría?**

El proyecto se encuentra actualmente en **fase de ideación y validación del MVP**.
...
Durante la fase de ideación buscamos validar:
...
> **CyberReady AI se encuentra actualmente en etapa de ideación y validación.**
